...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/home/kng/CLionProjects/ChatShare/vcpkg_installed/x64-linux' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=clang' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/kng/CLionProjects/ChatShare/vcpkg_installed/x64-linux/lib -L/home/kng/CLionProjects/ChatShare/vcpkg_installed/x64-linux/lib/manual-link' 'CPPFLAGS=-DNDEBUG' 'CXX=clang++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/kng/vcpkg/packages/libpq_x64-linux/lib/pkgconfig:/home/kng/vcpkg/packages/libpq_x64-linux/share/pkgconfig:/home/kng/CLionProjects/ChatShare/vcpkg_installed/x64-linux/lib/pkgconfig:/home/kng/CLionProjects/ChatShare/vcpkg_installed/x64-linux/share/pkgconfig'"
...
/* Define to 1 if with xml2 */
/* #undef HAVE_LIBXML2 */

/* Define to 1 if with xslt */
/* #undef HAVE_LIBXSLT */

/* Define to 1 if with zstd */
/* #undef HAVE_LIBZSTD */
...
#define PG_VERSION_STR "PostgreSQL 16.9 on x86_64-pc-linux-gnu, compiled by clang version 21.1.5, 64-bit"
